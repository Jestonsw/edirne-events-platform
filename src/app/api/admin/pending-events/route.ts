  ...
  try {
    ...
    if (action === 'approve') {
      ...
      const [newEvent] = await db.insert(events).values({
        ...
        submitterName: pendingEvent.submitterName,
        submitterEmail: pendingEvent.submitterEmail,
        submitterPhone: pendingEvent.submitterPhone,
        ...
        mediaFiles: pendingEvent.mediaFiles, // Copy media_files field
